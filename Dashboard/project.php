  ...
  <button type="button" class="btn btn-primary"> <i class="fa fa-search"></i> </button>
                    ...
                    --------------------\-\----------------------->
                      ...
                      <div class="form">
                        ...
                        <h4> Add Project  In Front Page </h4>

                    <form action="memb_insert.php" method="post" enctype="multipart/form-data" >
                      
                      <input type="file" required="" name="portfolio_img" class="mt-3 form-control-file"  >
                      
                      <input type="text" required="" autocomplete="off" name="portfolio_name" class="mt-3 form-control" placeholder="project_Name" >

                       <input type="submit" value="Add" name="portfolio" class="btn btn-danger mt-3" >
