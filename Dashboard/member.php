...
<div class="search-bar bg-white align-items-center d-flex" id="searchBox">
  ...
  <button type="button" class="btn btn-primary"> <i class="fa fa-search"></i> </button>
                    ...
                    --------------------\-\----------------------->
                      ...
                      <div class="form">
                         ...
                         <h4> Add Team Member To Website</h4>

                    <form action="memb_insert.php" method="post" enctype="multipart/form-data" >
                      
                      <input type="file" required="" name="memb_img" class="mt-3 form-control-file"  >
                      
                      <input type="text" required="" autocomplete="off" name="memb_name" class="mt-3 form-control" placeholder="Member Name" >

                       <input type="text" required="" autocomplete="off" name="memb_work" class="mt-3 form-control" placeholder="Member Field Name" >

                       <input type="submit" value="Add Member" name="add_member" class="btn btn-danger mt-3" >
          ...
          <!---The Addiing Client in website section  here -------------
                    --------------------\-\----------------------->


   <!-- <div class="add-member w-50 mt-5 ">
                    
                    <h4> Add Client Review To Website</h4>

                    <form action="memb_insert.php" method="post" enctype="multipart/form-data" >
                      
                      <input type="file" required="" name="client_img" class="mt-3 form-control-file"  >
                      
                      <input type="text" required="" autocomplete="off" name="client_name" class="mt-3 form-control" placeholder="client_Name" >

                       <input type="text" required="" autocomplete="off" name="client_comment" class="mt-3 form-control" placeholder="Client_comment" >

                       <input type="submit" value="Add Client" name="add_client" class="btn btn-danger mt-3" >
  ...
  <!--  <div class="add-member w-50 mt-5 ">
                    ...
                    <h4> Add Project  To Website</h4>

                    <form action="memb_insert.php" method="post" enctype="multipart/form-data" >
                      
                      <input type="file" required="" name="project_img" class="mt-3 form-control-file"  >
                      
                      <input type="text" required="" autocomplete="off" name="project_name" class="mt-3 form-control" placeholder="project_Name" >

                       <input type="text" required="" autocomplete="off" name="project_desc" class="mt-3 form-control" placeholder="project_desc" >

                    <input type="text" required="" autocomplete="off" name="project_link" class="mt-3 form-control" placeholder="project_link">


                       <input type="submit" value="Add project" name="add_project" class="btn btn-danger mt-3" >
 ...
 <!---The Addiing carrer in website section  here -------------
         --------------------\-\----------------------->

  <!--  <div class="add-member w-50 mt-5 ">
                    
                    <h4> Add Career  To Website</h4>

                    <form action="memb_insert.php" method="post" enctype="multipart/form-data" >
                      
                       
                      <input type="text" required="" autocomplete="off" name="carrer_name" class="mt-3 form-control" placeholder="carrer_name" >
<br>
                      Male
                      ...
                      <input type="text" name="experience" class="form-control mt-3 " placeholder="Experience" >

                      

                    <input type="text" required="" autocomplete="off" name="location" class="mt-3 form-control" placeholder="location" >

                    <textarea name="description" placeholder="description" class="mt-4 form-control" id="" cols="30" rows="10"></textarea>


                       <input type="submit" value="Add Carrer" name="add_career" class="btn btn-danger mt-3" >
...
<!---The Addiing counter in website section  here -------------
         --------------------\-\----------------------->
